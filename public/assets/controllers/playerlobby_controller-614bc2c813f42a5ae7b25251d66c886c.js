...
export default class extends Controller {
    ...
    initMercureSubscriptions() {
        ...
        fetch('/get-info/party',{
            ...
            this.partyCode = data[0];
            this.idPlayer = data[1];
        })
        ...
        const topicLaunch = encodeURIComponent('https://example.com/LaunchParty-'+this.partyCode);
        ...
        eventLaunch.onmessage = (event) => {
            ...
            console.log("laa2");
           this.launchPartyHandler(this.partyCode);
        };
