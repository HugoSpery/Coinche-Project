...
export default class extends Controller {
    ...
    initInfo() {
        ...
        this.code = document.querySelector('.plateau').slot;
        ...
        connect() {
            ...
            fetch('/game/choose-atout/' + this.code, {
                ...
                console.log("laaGameChooseAtout");
                this.btnSender.click();
    ...
    moveCards() {
        ...
        console.log(this.currentZoneIndex, this.currentRound);
        ...
        const targetZone = zones[this.currentZoneIndex];
    ...
    clickAtoutButton() {
        ...
        if (event.target.parentElement.dataset.type){
            event.target.parentElement.style.backgroundColor = "#00BFFF";
        }else{
