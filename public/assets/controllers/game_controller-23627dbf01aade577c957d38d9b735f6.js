...
export default class extends Controller {
    ...
    initInfo() {
        fetch('/get-info/party/', {
            ...
            console.log(data, info, this.code);
            console.log("laa");
        })
    }
    ...
    connect() {
        ...
        this.bottomZone = document.querySelector('.bottom .content-card');
        this.topZone = document.querySelector('.top .content-card');
        this.rightZone = document.querySelector('.right .content-card');
        this.leftZone = document.querySelector('.left .content-card');

        this.zones = [this.bottomZone, this.rightZone, this.topZone, this.leftZone];
    ...
    moveCards() {
        ...
        const targetZone = this.zones[this.currentZoneIndex];
        ...
        cardsToMove.forEach((card) => {
            ...
            const currentIndex = this.currentZoneIndex;
